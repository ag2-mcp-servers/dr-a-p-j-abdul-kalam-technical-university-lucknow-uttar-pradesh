...
#   timestamp: 2025-06-28T14:52:20+00:00
...
class CertificateParameters(BaseModel):
    ...
    EnrollmentNo: str = Field(
        ..., description='Enrollment No', examples=['123456789012']
    )
    FullName: str = Field(..., description='Full name', examples=['Sunil Kumar'])
    RollNo: str = Field(..., description='Roll No', examples=['1234567890'])
...
class CertificateParameters1(BaseModel):
    ...
    RollNo: str = Field(..., description='Roll No', examples=['1234567890'])
    UID: str = Field(..., description='Aadhaar number', examples=['123412341234'])
    Year: str = Field(..., description='Year', examples=['1,2,3,4,5'])


class DgmstCertificatePostRequest(BaseModel):
...
class DgmstCertificatePostResponse(BaseModel):
...
class DgmstCertificatePostResponse1(BaseModel):
...
class DgmstCertificatePostResponse2(BaseModel):
...
class DgmstCertificatePostResponse3(BaseModel):
...
class DgmstCertificatePostResponse4(BaseModel):
...
class DgmstCertificatePostResponse5(BaseModel):
...
class DgmstCertificatePostResponse6(BaseModel):
